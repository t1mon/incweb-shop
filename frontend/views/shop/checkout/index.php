                    ...
                    <div class="col-sm-5">
                        <div class="order-place">
                            ...
                            <div class="pay-meth">
                                ...
                                <?= Html::submitButton('ОФОРМИТЬ ЗАКАЗ', ['id'=>'submit-check' , 'class' => 'btn btn-small btn-dark pull-right','form' => 'order','onclick'=>'yaCounter46982373.reachGoal("ORDERмф  "); return true;']) ?>
                        </div>
                    </div>
                </div>
            </div>
