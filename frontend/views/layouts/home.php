        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 animate fadeInLeft" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;">
                    <div class="sma-hed">
                        <h2 style="font-size: 1.3em">Магазин мебели «Мебель Стайл» </h2>
                    </div>
                    <div class="about-detail">
                        <p style="text-indent: 20px;">
                            Специализирующаяся на продаже современной корпусной мебели, мягкой мебели,
                            обеденных зон, столов, стульев и ортопедических матрасов в Самаре.
                            В нашем ассортименте вы найдете много мебели от современных производителей,
                            как эконом сегмента, так и премиум класса.
                            <br><br>
                            На нашем официальном мебельном сайте вы найдете самые доступные мебельные цены в Самаре от производителей фабрик
                            ’’Disavi’’, ’’Лером’’, ’’Аврора’’, ’’Сантан’’, ’’Aurora’’, ’’СтолПром’’, "Мебель из Малазии", а так же есть возможность
                            обсудить индивидуальные размеры мебели под заказ. Каталог мебельной продукции составляет сотни наименований. У наших поставщиков
                            используются исключительно качественные и экологически чистые материалы.
                            <br><br>
                            Купить мебель вы можете в интернет магазине mebel-style.online, мы работаем только по заказам через интернет магазин,
                            именно поэтому у нас самые низкие цены, мы не включаем в стоимость товаров аренду огромных площадей, все что
                            Вам нужно это просто оформить заказ на понравившийся товар и наши менеджеры свяжутся с Вами в ближайшее время и помогут
                            с выбором товара. Посмотреть образцы расцветок мебели можно в офисе на ул. Партизанской 17, 3 этаж, офис 304, "ТЦ Мега Мебель", вход с задней стороны.
